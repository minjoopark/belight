        ...
        <nav className="container mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/news" className="text-red-700 dark:text-red-500 font-medium underline-animation">
                {t.nav.news}
              </Link>
              ...
              {newsArticles.map((article) => (
                <article 
                  ...
                  className={`bg-white dark:bg-slate-800 border dark:border-slate-700 hover:shadow-xl dark:hover:shadow-slate-700/50 transition-all duration-300 group ${
                    article.featured ? 'ring-2 ring-red-700 dark:ring-red-500' : ''
                  }`}
                >
                  <div className="p-6">
                    {/* Featured Badge */}
                    {article.featured && (
                      <div className="mb-4">
                        <span className="inline-block bg-red-700 dark:bg-red-500 text-white dark:text-white text-xs font-bold px-3 py-1 uppercase tracking-wider">
                          {t.featured}
                        </span>
                      </div>
                    )}
                    ...
                    <a 
                      ...
                      className="inline-flex items-center text-red-700 dark:text-red-500 font-medium hover:text-red-800 dark:hover:text-red-400 transition-colors"
                    >
                      {t.readMore}
