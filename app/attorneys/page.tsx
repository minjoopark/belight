        ...
        <nav className="container mx-auto px-6">
          <div className="flex justify-between items-center h-20">
            ...
            <div className="hidden md:flex items-center space-x-8">
              ...
              <Link href="/attorneys" className="text-red-700 dark:text-red-500 font-medium underline-animation">
                {t.nav.attorneys}
              </Link>
              ...
              {t.members.map((attorney, index) => (
                <div key={index} className="text-center">
                  <div className="mb-6">
                    ...
                    <p className="text-red-700 dark:text-red-500 font-medium">{attorney.title}</p>
                  </div>
